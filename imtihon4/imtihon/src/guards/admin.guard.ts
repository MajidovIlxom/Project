...
export class AdminGuard implements CanActivate {
    ...
    canActivate(context: ExecutionContext){
        ...
        async function verify(token: string, jwtService: JwtService){
            ...
            // Admin rolini tekshirish qismi
            if (!admin.role || (admin.role !== 'admin' && admin.role !== 'vendor')) {
                throw new BadRequestException("Foydalanuvchi admin yoki vendor roli mavjud emas")
            }
            return true
        }
